 ...
 * @since Chapter 02
 */
public class Problem03_LogicalOperators {
    public static void main(String[] args) {
        ...
        // 비가 오고 우산이 있는 경우를 판단
        System.out.println("비가 오고 우산이 있나요? " + (isRaining && hasUmbrella));
        ...
        // 차나 자전거 중 하나라도 있는지 판단
        System.out.println("차나 자전거가 있나요? " + (hasCar || hasBicycle));
        ...
        // 주말이 아닌지 판단 (평일 여부)
        System.out.println("평일인가요? " + (!isWeekend));
        ...
        // (점수가 70 이상이고 출석했거나) 또는 (숙제를 제출했는지) 판단
        boolean passed = (score >= 70 && attended) || submittedHomework;
        ...
        // y가 0일 때 나누기 연산을 피하는 안전한 조건
        boolean result = (y != 0) && (x / y > 2);
        System.out.println("\n안전한 나누기 결과: " + result);
