 ...
 * <h4>구현 알고리즘</h4>
 * <ol>
 *   <li><strong>외부 반복문:</strong> 각 층을 순회 (i = 1부터 height까지)</li>
 *   <li><strong>공백 출력:</strong> (height - i)개의 공백 출력</li>
 *   <li><strong>증가 부분:</strong> 1부터 i까지 숫자 출력</li>
 *   <li><strong>감소 부분:</strong> (i-1)부터 1까지 숫자 출력</li>
 *   <li><strong>줄바꿈:</strong> 각 층 출력 후 줄바꿈</li>
 * </ol>
 * 
 * <h4>힌트 및 도움말</h4>
 * <ul>
 ...
 * <h4>변형 문제</h4>
 * <ul>
 *   <li><strong>알파벳 피라미드:</strong> 숫자 대신 알파벳 사용</li>
 *   <li><strong>역 피라미드:</strong> 아래에서 위로 갈수록 넓어지는 형태</li>
 *   <li><strong>다이아몬드:</strong> 피라미드 + 역피라미드 조합</li>
 *   <li><strong>속이 빈 피라미드:</strong> 테두리만 출력</li>
 * </ul>
 * 
 * <h4>실무 응용</h4>
 * <ul>
 ...
 * </ul>
 */
public class Problem04_NumberPyramid {
