 ...
 * <h4>확장 아이디어</h4>
 * <ul>
 *   <li><b>난이도 선택:</b> 숫자 범위를 사용자가 선택 (1-50, 1-100, 1-1000)</li>
 *   <li><b>제한 횟수:</b> 특정 횟수 내에 맞추지 못하면 게임 오버</li>
 *   <li><b>점수 시스템:</b> 적은 시도로 맞출수록 높은 점수</li>
 *   <li><b>다시 하기:</b> 게임 종료 후 재시작 옵션 제공</li>
 *   <li><b>통계 기능:</b> 평균 시도 횟수, 최고 기록 등 저장</li>
 * </ul>
 * 
 * <h4>예외 처리 고려사항</h4>
 * <ul>
 ...
 * </ul>
 */
public class Exercise05_GuessNumber {
