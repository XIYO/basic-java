 ...
 * 
 * <p><strong>목표:</strong> 숫자형 기본 타입의 최소값과 최대값을 이해하고, 오버플로우/언더플로우 현상을 학습합니다.</p>
 * 
 ...
 * <div style="border: 2px solid #ff5722; border-radius: 5px; padding: 10px; background-color: #fbe9e7;">
 *   <ul>
 *     <li><strong>오버플로우:</strong> 최대값을 초과하면 최소값으로 순환</li>
 *     <li><strong>언더플로우:</strong> 최소값 미만이면 최대값으로 순환</li>
...
public class Exercise05_MinMaxValues {
    public static void main(String[] args) {
        ...
        // System.out.println("Byte 언더플로우: " + Byte.MIN_VALUE + " - 1 = " + ?);
