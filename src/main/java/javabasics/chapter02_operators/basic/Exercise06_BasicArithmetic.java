...
public class Exercise06_BasicArithmetic {
    public static void main(String[] args) {
         ...
         * 예시: int sum = a + b;
         */
        // TODO: a와 b의 합을 구해서 sum 변수에 저장하세요 (덧셈 연산자 사용)
        int sum = ???;
        
        // TODO: a에서 b를 뺀 값을 difference 변수에 저장하세요 (뺄셈 연산자 사용)
        int difference = ???;
        
        // TODO: a와 b의 곱을 product 변수에 저장하세요 (곱셈 연산자 사용)
        int product = ???;
        
        // TODO: a를 b로 나눈 몫을 quotient 변수에 저장하세요 (나눗셈 연산자 사용)
        int quotient = ???;
